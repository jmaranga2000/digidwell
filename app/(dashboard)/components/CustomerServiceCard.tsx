...
export default function CustomerServiceCard({
  ...
  return (
    <Card className="rounded-xl shadow-sm hover:shadow-md transition duration-300 border border-gray-200 dark:border-gray-700">
      <CardHeader>
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <Button
          className="w-full py-2 bg-primary text-white hover:bg-primary/90 transition"
